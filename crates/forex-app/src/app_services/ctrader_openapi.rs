...
pub mod internal_do_not_use_OpenApiCommonModelMessages {
    include!(concat!(env!("OUT_DIR"), "/protobuf_generated/OpenApiCommonModelMessages.u.pb.rs"));
}
...
pub mod internal_do_not_use_OpenApiModelMessages {
    include!(concat!(env!("OUT_DIR"), "/protobuf_generated/OpenApiModelMessages.u.pb.rs"));
}
#[allow(unused_imports, nonstandard_style)]
...
pub mod internal_do_not_use_OpenApiCommonMessages {
    include!(concat!(env!("OUT_DIR"), "/protobuf_generated/OpenApiCommonMessages.u.pb.rs"));
}
#[allow(unused_imports, nonstandard_style)]
...
pub mod internal_do_not_use_OpenApiMessages {
    include!(concat!(env!("OUT_DIR"), "/protobuf_generated/OpenApiMessages.u.pb.rs"));
}
#[allow(unused_imports, nonstandard_style)]
