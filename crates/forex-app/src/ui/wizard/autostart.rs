...
//! - Linux: `~/.config/autostart/forex-app.desktop` (freedesktop
...
pub const WIZARD_DEFAULT_WINDOWS_AUTOSTART_FILENAME: &str = "forex-app.lnk";
...
pub fn render(ui: &mut egui::Ui, controller: &mut WizardController) -> StepResult {
    ...
    ui.checkbox(
        ...
        "Start forex-app on system login.",
    );
