...
impl Default for RiskConfig {
    fn default() -> Self {
        ...
        for (tf, lambda) in [
            ...
            ("M30", 0.95),
            ("H1", 0.96),
            // H2 is canonical (operator requirement) and gets its own
            // EWMA decay between H1 and H4. cTrader fetch resamples
            // H2 from H1 client-side; see CANONICAL_TIMEFRAMES.
            ("H2", 0.965),
            ("H4", 0.97),
            ("H12", 0.98),
            ("D1", 0.985),
