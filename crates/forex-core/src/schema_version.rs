...
//!
//! - `forex_app::app_services::broker_config::BrokerSettingsState`
//!   (`broker_credentials.toml`)
//! - `forex_core::system::HardwareProfile` (`hardware_profile.json`)
//! - `forex_models::runtime::RuntimeArtifactMetadata` (embedded in
//!   each expert's saved-artifact metadata.json)
//! - `forex_core::symbol_metadata::SymbolMetadataTable`
