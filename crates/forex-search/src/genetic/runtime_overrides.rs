...
impl GeneticSearchRuntimeOverrides {
    ...
    /// [`DeterminismPolicy`] enum from `forex-core::contracts`. `Some(seed)`
...
/// [`forex_core::contracts::DeterminismPolicy`] derived from the
...
mod tests {
    ...
    #[test]
    fn determinism_policy_seed_round_trip_through_forex_core_helper() {
