...
impl Gene {
    ...
    pub fn normalize(&mut self, n_indicators: usize, min_indicators: usize) {
        ...
        // Canonicalize the linear part of the gene so the search does not waste
        // generations evaluating equivalent permutations such as [3, 7] and [7, 3],
        // or duplicate terms such as [3, 3, 7]. This keeps the search space large,
        // but removes mathematically redundant candidates before hashing/filtering.
