...
//!
//! Today `neoethos-app` computes unrealized PnL locally from
...
//! `crates/neoethos-app/tests/fixtures/ctrader/unrealized_pnl/` — see
...
/// `debug!(target = "neoethos_app::pnl_audit")` line per position and
...
mod tests {
    ...
    #[ignore = "TODO(real-data): requires a captured ProtoOAGetPositionUnrealizedPnLRes fixture \
                ...
                crates/neoethos-app/tests/fixtures/ctrader/unrealized_pnl/README.md for capture steps."]
    fn audit_unrealized_pnl_warns_when_broker_value_drifts_beyond_threshold_real_fixture() {
        ...
        // `crates/neoethos-app/tests/fixtures/ctrader/unrealized_pnl/pnl_audit_drift.json`,
    ...
    #[ignore = "TODO(real-data): requires a captured ProtoOAGetPositionUnrealizedPnLRes fixture \
                ...
                crates/neoethos-app/tests/fixtures/ctrader/unrealized_pnl/README.md."]
