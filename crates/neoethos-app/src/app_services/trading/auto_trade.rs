...
pub struct AutoTradeSignal {
    ...
    /// Stable identifier of the discovery-time strategy that fired
    ...
    /// content-hash of the loaded `EnsembleLoadSummary.loaded_names`.
    /// `None` for non-ML paths.
