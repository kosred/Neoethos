...
use neoethos_core::{Settings, logging::canonical_log_path};
...
pub struct BootstrapFormState {
    ...
    /// Each path is run through `neoethos_data::DatasetDiscovery::scan`
...
mod tests {
    ...
    fn app_state_falls_back_to_eurusd_when_symbol_list_is_empty() {
        ...
        let state = AppState::new(runtime, &neoethos_core::Settings::default(), Vec::new());
