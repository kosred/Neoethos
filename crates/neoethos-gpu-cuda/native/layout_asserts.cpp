...
static_assert(sizeof(NeoPopulationOutcome) == 64);
...
static_assert(offsetof(NeoPopulationOutcome, pnl) == 48);
static_assert(offsetof(NeoPopulationOutcome, r_multiple) == 56);
