...
pub struct RuntimeArtifactMetadata {
    ...
    #[serde(default = "neoethos_core::default_v1")]
    pub schema_version: neoethos_core::SchemaVersion,
...
impl neoethos_core::HasSchemaVersion for RuntimeArtifactMetadata {
    const CURRENT: neoethos_core::SchemaVersion = RUNTIME_ARTIFACT_METADATA_SCHEMA_VERSION;
    fn schema_version(&self) -> neoethos_core::SchemaVersion {
        self.schema_version
    }
}
