...
fn trade_trace_kernel(
    ...
    identity_in: &[u32],
    identity_out: &mut [u32],
    entry_directions: &mut [i32],
    exit_reasons: &mut [i32],
    trade_entry_bars: &mut [i32],
    trade_directions: &mut [i32],
    trade_sizes: &mut [f32],
    trade_costs: &mut [f32],
    trade_pnls: &mut [f32],
    trade_equities: &mut [f32],
    risk_equities: &mut [f32],
    risk_peaks: &mut [f32],
    risk_day_starts: &mut [f32],
    risk_month_starts: &mut [f32],
    risk_flags_out: &mut [i32],
    n_samples: u32,
    initial_equity: f32,
    stop_pips: f32,
    target_pips: f32,
...
fn launch_trade_trace<R: Runtime>(
    ...
    trade_trace_kernel::launch::<R>(
        ...
        CubeDim::new_1d(1),
        unsafe { BufferArg::from_raw_parts(close, n) },
        unsafe { BufferArg::from_raw_parts(high, n) },
        unsafe { BufferArg::from_raw_parts(low, n) },
        unsafe { BufferArg::from_raw_parts(signals, n) },
        unsafe { BufferArg::from_raw_parts(confidences, n) },
        unsafe { BufferArg::from_raw_parts(timestamp_deltas, n) },
        unsafe { BufferArg::from_raw_parts(month_ids, n) },
        unsafe { BufferArg::from_raw_parts(day_ids, n) },
        unsafe { BufferArg::from_raw_parts(adaptive_base, n) },
        unsafe { BufferArg::from_raw_parts(identity_in, identity_words.len()) },
        unsafe { BufferArg::from_raw_parts(identity_out.clone(), identity_words.len()) },
        unsafe { BufferArg::from_raw_parts(entry_directions.clone(), n) },
        unsafe { BufferArg::from_raw_parts(exit_reasons.clone(), n) },
        unsafe { BufferArg::from_raw_parts(trade_entry_bars.clone(), n) },
        unsafe { BufferArg::from_raw_parts(trade_directions.clone(), n) },
        unsafe { BufferArg::from_raw_parts(trade_sizes.clone(), n) },
        unsafe { BufferArg::from_raw_parts(trade_costs.clone(), n) },
        unsafe { BufferArg::from_raw_parts(trade_pnls.clone(), n) },
        unsafe { BufferArg::from_raw_parts(trade_equities.clone(), n) },
        unsafe { BufferArg::from_raw_parts(risk_equities.clone(), n) },
        unsafe { BufferArg::from_raw_parts(risk_peaks.clone(), n) },
        unsafe { BufferArg::from_raw_parts(risk_day_starts.clone(), n) },
        unsafe { BufferArg::from_raw_parts(risk_month_starts.clone(), n) },
        unsafe { BufferArg::from_raw_parts(risk_flags.clone(), n) },
        n as u32,
