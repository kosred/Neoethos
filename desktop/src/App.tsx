...
import NativeResearch from "./screens/NativeResearch";
...
type View =
  ...
  | "autopilot" | "riskymode" | "risk" | "discovery" | "nativeResearch" | "training" | "strategylab" | "strategyreport" | "intelligence"
...
const NAV: NavEntry[] = [
  ...
  { id: "nativeResearch", label: "Native Research", icon: "⚛" },
