...
6. Shared challenge/runtime/recovery/phase defaults now remove the locally provable duplication; the remaining 8 hardcoded tunables need config-shape decisions before code changes.
