...
$packageArgs = @{
    ...
    fileType       = 'exe'
    url64bit       = 'https://github.com/kosred/forex-ai/releases/download/v0.4.13/forex-app_0.4.13_x64-setup.exe'
    checksum64     = '03BCC6ECC9867891722C0186EADC85CCAB92128D1A5A5912CCE90C95D974F244'
