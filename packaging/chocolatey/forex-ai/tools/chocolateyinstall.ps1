...
$packageArgs = @{
    ...
    fileType       = 'exe'
    url64bit       = 'https://github.com/kosred/forex-ai/releases/download/v0.5.0/forex-app_0.5.0_x64-setup.exe'
    checksum64     = '613C5927DAD066748A3F81DB424B51832CAD38CDE3F81CD68F989AE2E205105C'
