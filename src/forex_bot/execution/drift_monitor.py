...
class ConceptDriftMonitor:
    ...
    def __init__(self, window_size: int = 100, threshold: float = 0.05):
        try:
            from forex_bindings import ConceptDriftMonitor as RustMonitor
    ...
    def update(self, y_true: int, y_pred_prob: np.ndarray) -> bool:
        ...
        return self._backend.update(y_true, probs)

    def should_retrain(self) -> bool:
        """Check if retraining is recommended."""
        return self._backend.should_retrain()
    ...
    def status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "last_drift_at": datetime.fromtimestamp(stat["last_drift_at"], UTC).isoformat() if stat["last_drift_at"] else None,
