...
pub enum DidiIndexError {
    ...
    #[error(
        "didi_index: Invalid medium_length: medium_length = {medium_length}, data length = {data_len}"
    )]
    InvalidMediumLength {
        medium_length: usize,
        data_len: usize,
    ...
    #[error(
        "didi_index: Output length mismatch: expected = {expected}, short = {short_got}, long = {long_got}, crossover = {crossover_got}, crossunder = {crossunder_got}"
    )]
