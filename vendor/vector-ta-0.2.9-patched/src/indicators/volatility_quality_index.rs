...
pub enum VolatilityQualityIndexError {
    ...
    AllValuesNaN,
    #[error(
        "volatility_quality_index: Inconsistent slice lengths: open={open_len}, high={high_len}, low={low_len}, close={close_len}"
    )]
    ...
    #[error("volatility_quality_index: Output length mismatch: expected = {expected}, got = {got}")]
